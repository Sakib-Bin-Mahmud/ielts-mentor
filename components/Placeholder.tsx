...
export function Placeholder({
  ...
  return (
    <span className={`group relative inline-block ${className}`}>
      ...
      <span className="pointer-events-none absolute -top-6 left-0 whitespace-nowrap rounded bg-navy px-2 py-0.5 text-[10px] font-sans font-medium tracking-wide text-paper opacity-0 transition-opacity group-hover:opacity-100 z-20">
        {label}
      </span>
    </span>
  );
